...
import type { PendingApproval, PendingUserInput } from "@t3tools/client-runtime/state/thread-activity";
...
export type { PendingApproval, PendingUserInput } from "@t3tools/client-runtime/state/thread-activity";
...
export { derivePendingApprovals, derivePendingUserInputs } from "@t3tools/client-runtime/state/thread-activity";
